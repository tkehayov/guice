...
public class ProfilePage {
  ...
  @Inject
  public ProfilePage(Provider<HttpServletRequest> request, Provider<HttpServletResponse> response, PersistentSessionRepository sessionRepository, FundsBalanceRepository repository) {
